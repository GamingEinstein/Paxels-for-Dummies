...
public class CustomDataMaps extends DataMapProvider {
    protected CustomDataMaps(PackOutput packOutput, CompletableFuture<HolderLookup.Provider> lookupProvider) {
